...
public class PlayerHealth : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            else
            {
               ...
               healthBar.color = Color.Lerp(healthBar.color, Color.red, flashSpeed * Time.deltaTime);
            }
        ...
        healthBar.transform.localScale = new Vector3((float)currentHealth/(float)startingHealth, 0.1f, 1f);
